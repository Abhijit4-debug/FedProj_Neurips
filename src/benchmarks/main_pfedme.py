...
def main_pfedme(args):
    ...
    for iteration in range(args.rounds):
        ...
        for k in ww.keys():
            ww[k] = net_glob.state_dict()[k] * (1 - args.pfedme_beta) + ww[k] * args.pfedme_beta
...
def run_pfedme(args, fname):
    ...
    for trial in range(args.ntrials):
        ...
        pfedme_ft_local, duration, f1, f2, f3, f4, f5, f6, ff1, ff2, ff3, ff4, ff5, ff6 = main_pfedme(args)
