...
def main_fedproj2(args):
    ...
    for idx in range(args.num_users):
        ...
        clients.append(Client_FedProj2(idx, copy.deepcopy(users_model[idx]), args.local_bs, args.local_ep,
                   args.lr, args.momentum, args.distill_T, args.gamma, args.device, train_dl_local, test_dl_local))
...
def run_fedproj2(args, fname):
    ...
    for trial in range(args.ntrials):
        ...
        fedavg_ft_local, duration, f1, f2, f3, f4, f5, f6, ff1, ff2, ff3, ff4, ff5, ff6 = main_fedproj2(args)
