...
def main_rcl(args):
    ...
    for idx in range(args.num_users):
        ...
        clients.append(Client_RCL(idx, copy.deepcopy(users_model[idx]), args.local_bs, args.local_ep,
    ...
    return (final_glob, avg_final_glob, best_glob, avg_final_local, avg_best_local, rcl_ft_local, duration,
           f1, f2, f3, f4, f5, f6, ff1, ff2, ff3, ff4, ff5, ff6)

def run_rcl(args, fname):
    alg_name = 'FedRcl'
    ...
    for trial in range(args.ntrials):
        ...
        rcl_ft_local, duration, f1, f2, f3, f4, f5, f6, ff1, ff2, ff3, ff4, ff5, ff6 = main_rcl(args)
        ...
        exp_rcl_ft_local.append(rcl_ft_local)
        ...
        # print(f'-- rcl+ Fine Tuning Clients AVG Local Acc: {exp_moon_ft_local[-1]:.2f}')
