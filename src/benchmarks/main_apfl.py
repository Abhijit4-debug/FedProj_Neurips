        ...
        if print_flag:
            ...
            for user in range(args.num_users):
                for key in w_locals[user].keys():
                    w_locals_test[user][key] = args.alpha_apfl*w_locals[user][key] + (1-args.alpha_apfl)*w_glob[key] 
...
def run_apfl(args, fname):
    ...
    for trial in range(args.ntrials):
        ...
        apfl_ft_local, duration, f1, f2, f3, f4, f5, f6, ff1, ff2, ff3, ff4, ff5, ff6 = main_apfl(args)
